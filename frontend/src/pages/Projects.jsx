...
const getProgress = (project) => {
  const value =
    project?.progress ?? project?.completion ?? project?.percentage ?? 0;
  ...
  return (
    ...
    >
      ...
      <div className="project-badges">
        <span className={`project-status ${getStatusClass(status)}`}>
          <span className="status-dot" />
          {status}
        </span>

        <span className={`project-priority ${getPriorityClass(priority)}`}>
          {priority}
        </span>
      </div>
    ...
    >
      <div className="project-row-name">
        ...
        <div>
          ...
          <span>{getProjectDescription(project)}</span>
        </div>
      </div>
      ...
      <div className="project-row-actions">
        <button type="button" onClick={() => onEdit(project)} title="Edit">
          <FaEdit />
        </button>
...
const Projects = () => {
  ...
  const filteredProjects = useMemo(() => {
    ...
    if (priorityFilter !== "All Priority") {
      result = result.filter(
        (project) => getProjectPriority(project) === priorityFilter,
      );
    }
  ...
  const statistics = useMemo(() => {
    ...
    const completed = projects.filter(
      (project) => getProjectStatus(project).toLowerCase() === "completed",
    ).length;

    const archived = projects.filter(
      (project) => getProjectStatus(project).toLowerCase() === "archived",
    ).length;

    const highPriority = projects.filter(
      (project) => getProjectPriority(project).toLowerCase() === "high",
    ).length;

    const needAttention = projects.filter(
      (project) =>
        getProgress(project) < 30 &&
        getProjectStatus(project).toLowerCase() !== "completed",
    ).length;
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (editingProject) {
        await editProject(getProjectId(editingProject), form);
  ...
  const handleDelete = async (project) => {
    const confirmed = window.confirm(
      `Delete "${getProjectName(project)}"? This action cannot be undone.`,
    );
    ...
    try {
      await removeProject(getProjectId(project));
        ...
        <main className="projects-content">
          ...
          >
            <div className="hero-main">
              ...
              <h1>
                Welcome back,
                <span>Souradipta Patra</span>
              </h1>

              <p>
                Organize projects, collaborate with your team, track progress,
              ...
              <div className="score-mini-grid">
                ...
                <div>
                  <strong>
                    {statistics.active > 0
                      ? Math.round(
                          (statistics.active / Math.max(statistics.total, 1)) *
                            100,
                        )
                      : 0}
                    %
          ...
          >
            <button type="button" className="shortcut-card">
              ...
              <span className="shortcut-text">
                ...
                <small>View and manage all projects</small>
              </span>
            </button>
            ...
            >
              ...
              <span className="shortcut-text">
                ...
                <small>Start a new project from scratch</small>
              </span>
            </button>
            ...
            <button type="button" className="shortcut-card">
              ...
              <span className="shortcut-text">
                ...
                <small>Invite team members and collaborate</small>
              </span>
            </button>
            ...
            <button type="button" className="shortcut-card">
              ...
              <span className="shortcut-text">
                ...
                <small>Monitor project progress and milestones</small>
              </span>
            </button>
            ...
            <button type="button" className="shortcut-card">
              ...
              <span className="shortcut-text">
                ...
                <small>Use templates for quick setup</small>
              </span>
            </button>
            ...
            <button type="button" className="shortcut-card">
              ...
              <span className="shortcut-text">
                ...
                <small>View insights and project analytics</small>
              </span>
            </button>
          </motion.section>
          ...
          >
            <div className="project-stat-card">
              ...
              <div className="stat-sparkline">╱╲_╱╲╱</div>
            </div>
            ...
            <div className="project-stat-card">
              ...
              <div className="stat-content">
                <strong>{statistics.needAttention}</strong>
