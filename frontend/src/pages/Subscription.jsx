...
function Subscription() {
  ...
  const handleUpgrade = async (amount, plan) => {
    try {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center px-6 py-12">
      ...
      <p className="text-slate-400 mb-12">
        Upgrade your productivity with TaskFlow Pro
      </p>
      ...
      <div className="grid md:grid-cols-3 gap-8 w-full max-w-6xl">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-lg">
          ...
          <button className="w-full bg-slate-700 py-3 rounded-lg" disabled>
            Current Plan
          </button>
        </div>

        <div className="bg-indigo-600 rounded-2xl p-8 shadow-xl scale-105">
          <h2 className="text-2xl font-bold mb-4">Pro Monthly</h2>
          ...
          <button
            onClick={() => handleUpgrade(1, "PRO_MONTHLY")}
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold mb-4">Pro Yearly</h2>
          ...
          <button
            onClick={() => handleUpgrade(2, "PRO_YEARLY")}
